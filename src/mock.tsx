    ...
    categorias: [
        {
            ...
            videos: [
                ...
                {
                    titulo:
                        'Qual é a melhor linguagem de programação? #HipstersPontoTube',
        ...
        },
        {
            ...
            videos: [
                ...
                {
                    titulo:
                        'Coders4Tips - S01E04: GitHub CLI - Uma Nova Experiência no Github!',
        ...
        },
        {
            ...
            linkExtra: {
                ...
                url:
                    'https://alura.com.br/curso-online-aprender-a-aprender-tecnicas-para-seu-autodesenvolvimento',
            },
            videos: [
                {
                    titulo: 'Como estudar melhor?',
                    url:
                        'https://www.youtube.com/watch?v=Is6c9KSGCbk&feature=youtu.be',
                },
                {
                    titulo: 'Faculdade',
                    url:
                        'https://www.youtube.com/watch?v=jw06H8esyzQ&feature=youtu.be',
                },
                {
                    titulo: 'Frameworks',
                    url: 'https://www.youtube.com/watch?v=QzDjdlF1BQI',
                ...
                },
                {
                    ...
                    url:
                        'https://www.youtube.com/watch?v=MwCx2qKdbDw&feature=youtu.be',
                },
            ],
        },
    ],
